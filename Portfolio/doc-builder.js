...
DOCS['cu2-wa4'] = M({
  ...
  content: [
    ...
    p('Validation on both indexing reasons stands at “Not Started”. Validation is the step that asks Google to re-check a fixed page, so it is deliberately left until the readable-text correction has been made — starting it before the fix would return the same result.', { before: 100 }),
