                      ...
                      <div className="mt-6 flex flex-wrap gap-3">
                        ...
                        {prog.brochure && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-sm px-6 py-2.5 text-ink-600 hover:text-gold-500 transition-colors underline underline-offset-2"
                          >
                            Muat Turun Brosur
                          </a>
                        )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {coming.map(prog => (
                  <Link key={prog.slug} href={`/program/${prog.slug}`} className="card p-6 opacity-70 hover:opacity-100 transition-opacity block">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${prog.color} flex items-center justify-center text-2xl mb-4`}>
                      {prog.icon}
                    </div>
