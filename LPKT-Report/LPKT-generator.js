...
const senaraiJadual = [
  ...
  indent('Jadual 3.12  Status Prospek dalam Sistem CRM'),
...
const bab1 = [
  ...
  blank(),
  bodyRun([{ text: 'vii.  Rekod Status Prospek Tidak Lengkap: ', bold: true }, { text: 'Sistem CRM masih dalam fasa pelaksanaan sepanjang tempoh kempen. Pasukan pengambilan menjalankan susulan melalui WhatsApp tanpa mengemas kini status setiap prospek dalam sistem. Justeru, data peringkat corong dalam CRM tidak mencerminkan aktiviti susulan sebenar dan tidak digunakan untuk mengukur kadar penukaran mengikut peringkat.' }]),
  blank(),
  bodyRun([{ text: 'viii. Kadar Penukaran Dipengaruhi Faktor Luar Kawalan Kempen: ', bold: true }, { text: 'Penukaran prospek kepada pelajar berdaftar bergantung kepada proses susulan oleh pasukan pengambilan, kelulusan pembiayaan PTPK dan keputusan peribadi calon — faktor yang berada di luar skop aktiviti pemasaran media sosial yang didokumentasikan dalam LPKT ini.' }]),
...
const bab3 = [
  ...
  blank(),
  body('Jadual 3.12: Status Prospek dalam Sistem CRM (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
