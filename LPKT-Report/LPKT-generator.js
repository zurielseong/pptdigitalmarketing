...
const bab1 = [
  ...
  blank(),
  bodyRun([{ text: 'ii.   Institusi TVET lain di kawasan luar bandar: ', bold: true }, { text: 'LPKT ini membuktikan bahawa institusi kemahiran di kawasan pedalaman dan wilayah Pantai Timur boleh bersaing merebut perhatian bakal pelajar melalui media sosial dengan strategi yang sistematik dan belanjawan yang terkawal. Pendekatan jenama payung yang digunakan juga boleh dicontohi oleh pusat bertauliah lain yang berkongsi lokasi atau pasaran yang sama.' }]),
  blank(),
