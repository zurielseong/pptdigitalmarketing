...
const coverPage = [
  ...
  center('HUB PENDIDIKAN TVET LIPIS', { bold: true }),
  center('Kolej Islam Antarabangsa Kuala Lipis'),
...
const pengesahanPage = [
  ...
  bodyRun([{ text: 'Pusat Bertauliah    : ', bold: true }, { text: 'Hub Pendidikan TVET Lipis, Kolej Islam Antarabangsa Kuala Lipis' }]),
  blank(),
...
const abstractSection = [
  ...
  blank(),
  body('Walau bagaimanapun, hanya 16 prospek (0.46%) bertukar menjadi pelajar berdaftar. Analisis diagnostik ke atas data CRM mendapati puncanya bukan pada strategi pemasaran — penyasaran adalah tepat dengan 86.4% prospek berumur 21 tahun ke bawah — tetapi pada jurang susulan operasi, di mana 2,656 prospek (76.5%) tidak pernah dihubungi dan hanya 0.1% mempunyai rekod interaksi. Dalam kerangka RACE, kempen berjaya pada fasa Reach, Act dan Convert tetapi gagal pada fasa Engage.'),
  blank(),
  body('Tujuh cadangan penambahbaikan dikemukakan mengikut keutamaan impak, dengan penutupan jurang susulan prospek sebagai keutamaan tertinggi — pengusahaan penuh pangkalan data sedia ada berpotensi menghasilkan kira-kira 58 pendaftaran tambahan tanpa perbelanjaan iklan baharu.'),
  blank(),
...
const senaraiJadual = [
  ...
  indent('Jadual 3.5   Prestasi Facebook Organik Mengikut Bulan'),
  indent('Jadual 3.6   Prestasi Meta Ads — Kempen Lead Generation'),
  indent('Jadual 3.7   Prestasi Carian Organik tvetlipis.my'),
  indent('Jadual 3.8   Kata Kunci Teratas (Google Search Console)'),
  indent('Jadual 3.9   Jumlah Prospek Online Mengikut Sumber'),
  indent('Jadual 3.10  Prospek Online Mengikut Bulan dan Saluran'),
  indent('Jadual 3.11  Prospek Online Mengikut Kursus'),
  indent('Jadual 3.12  Kadar Penukaran Prospek — Corong Pemasaran'),
  indent('Jadual 3.13  Profil Demografi Prospek'),
  indent('Jadual 3.14  Negeri Teratas Mengikut Bilangan Prospek'),
  indent('Jadual 3.15  Analisis Diagnostik Punca Kadar Penukaran Rendah'),
  indent('Jadual 3.16  Penilaian Pencapaian Objektif Kempen'),
  blank(),
...
const tocSection = [
  ...
  indent('3.8  Analisis Punca Kadar Penukaran Rendah'),
...
const bab1 = [
  ...
  body('TVET Lipis, dikenali rasminya sebagai Hub Pendidikan TVET Lipis di bawah naungan Kolej Islam Antarabangsa Kuala Lipis, merupakan institusi pendidikan kemahiran berdaftar di bawah Jabatan Pembangunan Kemahiran (JPK) nombor tauliah K16005, terletak di Jalan Hospital, 27200 Kuala Lipis, Pahang. Institusi ini menawarkan program Diploma Kemahiran Malaysia (DKM) dalam bidang Pendidikan Awal Kanak-Kanak (PAKK), Pra-Sekolah, Multimedia dan Elektrik, dengan pembiayaan melalui skim Perbadanan Tabung Pembangunan Kemahiran (PTPK).'),
  blank(),
  ...
  blank(),
  bodyRun([{ text: 'iv.   Data Kandungan Organik Tidak Berpecah Bulanan: ', bold: true }, { text: 'TikTok Analytics hanya menyediakan pecahan organik berbanding berbayar bermula 1 Mac 2026. Tontonan bagi Januari dan Februari 2026 tidak dapat diasingkan mengikut kategori tersebut.' }]),
  blank(),
  bodyRun([{ text: 'v.    Pengesanan Prospek Luar Borang: ', bold: true }, { text: 'Hanya prospek yang mengisi borang Lead Generation direkodkan secara automatik dengan sumber yang tepat. Prospek yang menghubungi terus melalui WhatsApp, panggilan telefon atau lawatan tidak dapat dikaitkan dengan saluran pemasaran tertentu.' }]),
  blank(),
  bodyRun([{ text: 'vi.   Tiada Meta Pixel: ', bold: true }, { text: 'Tanpa Meta Pixel di laman web tvetlipis.my, kempen retargeting tidak dapat dilaksanakan dan pengesanan penukaran daripada lawatan laman web kepada pertanyaan tidak sepenuhnya automatik.' }]),
  blank(),
  bodyRun([{ text: 'vii.  Kadar Penukaran Dipengaruhi Faktor Luar Kawalan Kempen: ', bold: true }, { text: 'Penukaran prospek kepada pelajar berdaftar bergantung kepada proses susulan oleh pasukan pengambilan, kelulusan pembiayaan PTPK dan keputusan peribadi calon — faktor yang berada di luar skop aktiviti pemasaran media sosial yang didokumentasikan dalam LPKT ini.' }]),
...
const bab2 = [
  ...
  simpleTable(
    ...
    [
      ...
      ['Facebook', 'Meta Business Suite → Page Insights', 'Jangkauan siaran, penglibatan halaman, pengikut'],
...
const bab3 = [
  ...
  body('Facebook berfungsi dalam kempen ini sebagai saluran organik sokongan dan sebagai platform penempatan (placement) bagi kempen Meta Ads. Kandungan video yang dihasilkan untuk TikTok diterbitkan semula di halaman Facebook bagi menjangkau Persona B, iaitu ibu bapa dan penjaga yang lebih aktif di platform tersebut.'),
  blank(),
  body('Jadual 3.5: Prestasi Facebook Organik (Januari – Jun 2026)', { bold: true }),
  blank(),
  body('Cara mendapatkan data ini: Buka Meta Business Suite → Insights → Facebook Page → Tukar tempoh kepada Jan–Jun 2026.', { italics: true, color: '666666' }),
  blank(),
  simpleTable(
    ['Metrik Facebook Organik', 'Nilai (Jan – Jun 2026)', 'Sumber Data'],
    [
      ['Jangkauan Organik', '⚠️ ISI', 'Meta Business Suite → Page Insights'],
      ['Tayangan Kandungan', '⚠️ ISI', 'Meta Business Suite → Page Insights'],
      ['Penglibatan Halaman', '⚠️ ISI', 'Meta Business Suite → Page Insights'],
      ['Pengikut Baharu', '⚠️ ISI', 'Meta Business Suite → Page Insights'],
    ],
    [4000, 2680, 2680]
  ),
  blank(),
  screenshot('Lampiran D-1: Meta Business Suite → Insights → Facebook Page → Tukar tempoh ke Jan–Jun 2026 → Screenshot Overview (Reach, Engagement, New Followers)'),
  blank(),
  body('Jadual 3.6: Prestasi Meta Ads — Kempen Lead Generation (Januari – Jun 2026)', { bold: true }),
  blank(),
  ...
  body('Jadual 3.7: Prestasi Carian Organik tvetlipis.my (Januari – Jun 2026)', { bold: true }),
  blank(),
  ...
  blank(),
  body('Jadual 3.8: 5 Kata Kunci Teratas (Google Search Console)', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.9: Jumlah Prospek Online Mengikut Sumber (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.10: Prospek Online Mengikut Bulan dan Saluran (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.11: Prospek Online Mengikut Kursus (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.12: Kadar Penukaran Prospek (Leads) kepada Pelajar Berdaftar — Corong Pemasaran', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.13: Profil Demografi Prospek (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
  ...
  blank(),
  body('Jadual 3.14: 5 Negeri Teratas Mengikut Bilangan Prospek (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
  ...
  h2('3.8  Analisis Punca Kadar Penukaran Rendah'),
  body('Dapatan paling ketara dalam kajian ini ialah jurang antara jumlah prospek yang dijana (3,470) dengan bilangan pelajar yang akhirnya berdaftar (16), iaitu kadar penukaran 0.46%. Memandangkan kadar ini jauh di bawah jangkaan, satu analisis diagnostik telah dijalankan ke atas data CRM bagi mengenal pasti punca sebenar. Analisis ini penting kerana tindakan pembetulan yang berkesan bergantung sepenuhnya kepada ketepatan diagnosis.'),
  blank(),
  body('Jadual 3.15: Analisis Diagnostik Punca Kadar Penukaran Rendah', { bold: true }),
  blank(),
  simpleTable(
    ['Hipotesis Punca', 'Bukti daripada Data CRM', 'Kesimpulan'],
    [
      ['H1: Prospek tidak dihubungi (jurang susulan)', '2,656 daripada 3,470 prospek (76.5%) masih berada di peringkat "Lead" tanpa sebarang tindakan susulan direkodkan', 'DISAHKAN — punca utama'],
      ['H2: Aktiviti susulan tidak direkodkan', 'Hanya 3 prospek (0.1%) mempunyai catatan dalam medan call_log CRM', 'DISAHKAN — susulan (jika berlaku) tidak dapat diukur atau dipantau'],
      ['H3: Corong bocor selepas hubungan pertama', '735 prospek dihubungi, tetapi hanya 62 (8.4%) mencapai peringkat Potential dan 16 (2.2%) menjadi Customer', 'DISAHKAN — kualifikasi dan pemupukan selepas sentuhan pertama adalah lemah'],
      ['H4: Tiada strategi pemasaran semula', 'Tiada prospek direkodkan dalam peringkat retargeting; tiada prospek ditanda KIV', 'DISAHKAN — prospek yang tidak bertindak balas tidak disasarkan semula'],
      ['H5: Penyasaran iklan tidak tepat (audiens salah)', 'Hanya 4.5% prospek berumur melebihi 25 tahun; 86.4% berumur 21 tahun ke bawah — selaras dengan Persona A', 'DITOLAK — penyasaran adalah tepat'],
      ['H6: Kualiti kandungan atau iklan lemah', '2,927,157 tontonan video; 3,470 prospek mengisi borang secara sukarela', 'DITOLAK — kandungan dan iklan berjaya menarik tindakan'],
    ],
    [2400, 4200, 2760]
  ),
  blank(),
  body('Analisis diagnostik ini menunjukkan dengan jelas bahawa kadar penukaran rendah bukanlah kegagalan strategi pemasaran media sosial. Empat daripada enam hipotesis yang disahkan (H1 hingga H4) kesemuanya berkaitan dengan proses operasi susulan prospek selepas borang diisi — iaitu peringkat yang berada di luar skop aktiviti pemasaran digital. Sebaliknya, dua hipotesis yang menguji keberkesanan pemasaran itu sendiri (H5 penyasaran dan H6 kualiti kandungan) kedua-duanya ditolak berdasarkan bukti data.'),
  blank(),
  body('Dalam kerangka RACE (Chaffey, 2022), kempen ini berjaya sepenuhnya pada fasa Reach (2.9 juta tontonan), Act (penglibatan tinggi) dan Convert (3,470 borang diisi), tetapi mengalami kegagalan pada fasa Engage — iaitu peringkat di mana prospek yang telah menunjukkan minat perlu dipupuk sehingga membuat keputusan pendaftaran. Pengenalpastian titik kegagalan yang spesifik ini merupakan asas kepada cadangan penambahbaikan dalam Bab 4.'),
  blank(),
  body('Sebagai gambaran potensi yang belum direalisasikan: sekiranya hanya 5% daripada 2,656 prospek yang belum dihubungi berjaya dihubungi dan ditukar pada kadar semasa 2.2% (kadar penukaran bagi prospek yang telah dihubungi), ini bersamaan tambahan kira-kira 3 pelajar berdaftar. Sekiranya kesemua 2,656 prospek dihubungi pada kadar penukaran yang sama, potensi tambahan adalah kira-kira 58 pelajar — hampir empat kali ganda jumlah pendaftaran semasa. Pengiraan ini menunjukkan nilai komersial prospek yang sedia ada dalam pangkalan data tetapi belum diusahakan.'),

  h2('3.9  Pencapaian Berbanding Objektif'),
  body('Jadual 3.16 menilai sejauh mana setiap objektif kempen yang ditetapkan dalam Bab 1 telah dicapai berdasarkan data yang dikumpulkan.'),
  blank(),
  body('Jadual 3.16: Penilaian Pencapaian Objektif Kempen (Januari – Jun 2026)', { bold: true }),
  blank(),
  simpleTable(
    ...
    [
      ...
      ['Obj. 3: Nilai keberkesanan dan kemukakan cadangan berasaskan data', 'Kadar penukaran prospek kepada pelajar berdaftar dianalisis; punca prestasi dikenal pasti; cadangan dikemukakan', '3,470 prospek dijana (Meta 2,336; TikTok 1,134). 16 pelajar berdaftar — kadar penukaran 0.46%. Analisis diagnostik mengenal pasti jurang susulan sebagai punca utama (76.5% prospek tidak dihubungi). Enam cadangan berasaskan data dikemukakan dalam Bab 4.', 'DICAPAI SEBAHAGIAN — penjanaan prospek melebihi jangkaan, namun sasaran penukaran kepada pendaftaran tidak dicapai'],
    ],
    [2200, 2200, 3200, 1760]
  ),
  blank(),
  body('Analisis Objektif yang Dicapai Sebahagian:', { bold: true }),
  blank(),
  body('Objektif ketiga dinilai sebagai DICAPAI SEBAHAGIAN. Komponen analisis dan cadangan telah dilaksanakan sepenuhnya, dan penjanaan prospek jauh melebihi jangkaan awal — 3,470 prospek dalam tempoh enam bulan bagi sebuah institusi kemahiran di kawasan pedalaman merupakan pencapaian yang tidak mungkin dicapai melalui kaedah pemasaran konvensional. Walau bagaimanapun, matlamat akhir kempen iaitu peningkatan pengambilan pelajar hanya menghasilkan 16 pendaftaran.'),
  blank(),
  body('Berdasarkan analisis diagnostik dalam seksyen 3.8, jurang ini berpunca daripada ketiadaan proses susulan berstruktur dan bukan daripada kelemahan strategi media sosial. Pengiktirafan jujur terhadap batasan ini — serta pengenalpastian tepat puncanya — merupakan asas kepada cadangan penambahbaikan yang dikemukakan dalam Bab 4.'),
  pageBreak(),
];
...
const bab4 = [
  ...
  blank(),
  bodyRun([{ text: 'i.    Ketiadaan Proses Susulan Berstruktur: ', bold: true }, { text: 'Kelemahan paling kritikal. Kempen dirancang untuk menjana prospek tanpa memastikan terlebih dahulu bahawa kapasiti dan proses susulan mencukupi untuk mengusahakan volum tersebut. Akibatnya 76.5% prospek tidak pernah dihubungi.' }]),
  blank(),
  bodyRun([{ text: 'ii.   Aktiviti Susulan Tidak Direkodkan: ', bold: true }, { text: 'Hanya 3 prospek (0.1%) mempunyai catatan dalam medan call_log. Tanpa rekod interaksi, prestasi susulan tidak dapat diukur, dipantau atau diperbaiki.' }]),
  blank(),
  ...
  h2('4.3  Cadangan'),
  body('Cadangan berikut disusun mengikut keutamaan berdasarkan potensi impak terhadap pengambilan pelajar, sebagaimana ditunjukkan oleh analisis diagnostik dalam seksyen 3.8.'),
  blank(),
  bodyRun([{ text: 'i.    Tutup Jurang Susulan Prospek (Keutamaan Tertinggi)', bold: true }]),
  body('Cadangan ini mempunyai potensi impak terbesar kerana ia menyasarkan punca utama yang telah disahkan. Tiga tindakan spesifik dicadangkan: (a) menetapkan piagam susulan hari-sama (same-day first-contact SLA) bagi setiap prospek baharu yang masuk; (b) memaparkan senarai prospek tertunggak di Dashboard CRM supaya jurang susulan kelihatan kepada pengurusan setiap hari; dan (c) mengagihkan 2,656 prospek sedia ada yang belum dihubungi kepada kakitangan secara berperingkat. Berdasarkan kadar penukaran semasa bagi prospek yang telah dihubungi (2.2%), pengusahaan penuh pangkalan data sedia ada berpotensi menghasilkan kira-kira 58 pendaftaran tambahan tanpa sebarang perbelanjaan iklan baharu.'),
  blank(),
  bodyRun([{ text: 'ii.   Wajibkan Perekodan Setiap Interaksi dalam CRM', bold: true }]),
  body('Setiap panggilan, mesej WhatsApp dan interaksi dengan prospek hendaklah direkodkan dalam medan call_log CRM. Tanpa rekod ini, prestasi susulan tidak dapat diukur mengikut kakitangan, punca kegagalan tidak dapat dikenal pasti, dan bimbingan prestasi tidak dapat diberikan. Penetapan medan follow_up_date bagi setiap prospek baharu turut dicadangkan bagi memastikan tiada prospek tertinggal.'),
  blank(),
  bodyRun([{ text: 'iii.  Agihkan Semula Belanjawan Iklan Mengikut Prestasi Saluran', bold: true }]),
  body('Data enam bulan menunjukkan TikTok Ads berkembang secara konsisten manakala Meta Ads merosot kepada 56 prospek pada Jun 2026. Dicadangkan peruntukan belanjawan dialihkan mengikut prestasi semasa, sambil menjalankan ujian diagnostik ke atas Meta Ads bagi menentukan sama ada penurunan berpunca daripada keletihan kreatif, pengurangan belanjawan atau isu akaun. Peningkatan belanjawan pada tempoh Oktober hingga Disember (musim keputusan SPM) turut dicadangkan bagi menyelaraskan perbelanjaan dengan kitaran keputusan bakal pelajar.'),
  blank(),
  bodyRun([{ text: 'iv.   Tambah Soalan Kelayakan pada Borang Prospek', bold: true }]),
  body('Borang Lead Generation Meta Ads perlu ditambah medan umur dan status pemohon (pelajar sendiri, ibu bapa yang bertanya bagi pihak anak, atau penukar kerjaya). Ini membolehkan prospek dikategorikan dan disalurkan kepada skrip perbualan yang bersesuaian, di samping melengkapkan data demografi yang kini hanya meliputi 32.6% rekod.'),
  blank(),
  bodyRun([{ text: 'v.    Selaraskan Kandungan dengan Permintaan Sebenar', bold: true }]),
  body('Data CRM menunjukkan PAKK menyumbang 54.8% permintaan dan Pra-Sekolah 21.7% — bersamaan 76.5% permintaan tertumpu kepada dua program pendidikan kanak-kanak. Kandungan dan iklan wajar diselaraskan mengikut nisbah permintaan ini, serta disasarkan kepada negeri berprestasi tinggi iaitu Selangor, Kelantan, Pahang dan Johor. Kapasiti pengambilan bagi program berkenaan juga perlu dirancang selaras dengan permintaan yang direkodkan.'),
  blank(),
  bodyRun([{ text: 'vi.   Pasang Meta Pixel dan Bina Strategi Pemasaran Semula', bold: true }]),
  body('Pemasangan Meta Pixel di tvetlipis.my akan membolehkan pembinaan audiens pemasaran semula daripada pelawat laman web, pengesanan penukaran yang lebih tepat, dan pengoptimuman automatik iklan berdasarkan data penukaran sebenar. Prospek yang tidak bertindak balas kepada sentuhan pertama boleh disasarkan semula secara automatik dan berkos rendah.'),
  blank(),
  bodyRun([{ text: 'vii.  Program Duta Pelajar dan Perluasan ke YouTube Shorts', bold: true }]),
  body('Melibatkan pelajar semasa sebagai pencipta kandungan akan meningkatkan keaslian mesej sambil mengurangkan beban pengeluaran kandungan yang kini ditanggung oleh seorang individu. Kandungan video pendek sedia ada juga boleh diterbitkan semula di YouTube Shorts tanpa kos pengeluaran tambahan, memandangkan kandungan telah pun dihasilkan untuk TikTok (Tuten & Solomon, 2020).'),
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(`${SCRATCHPAD}/LPKT-CU1-Zuriel-Seong-v6.docx`, buf);
  console.log('Done: LPKT-CU1-Zuriel-Seong-v6.docx');
});
